    ...
    <div class="container my-5">
        ...
        <form action="?page=cadastrar-paciente" method="post">
            ...
            <div class="mb-3">
                ...
                <a href="../Projeto-Gustavo/listar-paciente.php" class="btn btn-danger">Cancelar</a>
            </div>
        </form>

        <!-- Botão para voltar à home -->
        <div class="mt-4">
            <a href="http://localhost/Projeto%20Gustavo/" class="btn btn-primary">Voltar para a Home</a>
        </div>
